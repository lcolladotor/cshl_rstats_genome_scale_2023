...
One of the main characteristics of `SumarizedExperiment` is that it allows you to handle you data in a "coordinated" way. For example, if you want to subset your data, with `SummarizedExperiment` you can do so without worring your assays and metadata unsync.
...
## how to explore the object try to find other function that gives you the answer
se
...
## If you use assays() whitout specifying the elemnt you want to see it shows you the length
...
## Which can also be use to change names
assayNames(se)[1] <- "foo"
assayNames(se)
