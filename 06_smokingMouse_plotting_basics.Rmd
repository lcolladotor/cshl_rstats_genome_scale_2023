...
<figure>
    <img src="Figures/all_analyses.png" width="700px" align=center />
        <figcaption style="color: gray; line-height: 0.87; text-align: justify">
            <font size="-1.8">
                <b>Figure 1</b>: <b> Summary of the analyses. </b> Steps in yellow will be properly performed. 
...
multiple_QC_scatterplots <- function(qc_metric1, qc_metric2){
    ...
    p <- plot_grid(plots[[1]], plots[[2]], plots[[3]], plots[[4]], plots[[5]], plots[[6]], nrow = 2, rel_widths = c(1.1,1,1.2) )
    
    p + theme(plot.margin = unit(c(0.5,0.1,0.5,0.1), "cm"))
}
